...
/// Mevcut kullanıcıyı düzenleme dialog'u — Bottom sheet olarak açılır
...
class _EditUserDialogState extends State<EditUserDialog> {
  ...
  void initState() {
    super.initState();
    _fullNameController.text = widget.targetUser.fullName;
    _usernameController.text = widget.targetUser.username;
    if (widget.targetUser.password != null) {
      _passwordController.text = widget.targetUser.password!;
    }
  }
  ...
  Future<void> _handleUpdate() async {
    ...
    try {
      ...
      // Eğer kullanıcı adı değişmişse, başkası almış mı diye kontrol et
      if (username != widget.targetUser.username) {
