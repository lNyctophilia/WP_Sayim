...
class AppStrings {
  ...
  static const Map<String, Map<String, String>> _strings = {
    ...
    'manager_a1_in_city': {'tr': 'A1 Yönetici (Şehir İçi)', 'en': 'Manager A1 (In-City)'},
    'manager_a1_out_city': {'tr': 'A1 Yönetici (Şehir Dışı)', 'en': 'Manager A1 (Out-of-City)'},
    'manager_a2_in_city': {'tr': 'A2 Yönetici (Şehir İçi)', 'en': 'Manager A2 (In-City)'},
    'manager_a2_out_city': {'tr': 'A2 Yönetici (Şehir Dışı)', 'en': 'Manager A2 (Out-of-City)'},
    'manager_a3_in_city': {'tr': 'A3 Yönetici (Şehir İçi)', 'en': 'Manager A3 (In-City)'},
    'manager_a3_out_city': {'tr': 'A3 Yönetici (Şehir Dışı)', 'en': 'Manager A3 (Out-of-City)'},
    ...
    'notification_help': {'tr': 'Bildirim gelmiyor mu?', 'en': 'No notifications?'},
    'click_for_solution': {'tr': 'Çözüm için tıkla', 'en': 'Click for solution'},
    'device_not_supported': {'tr': 'Cihazınız bu özelliği desteklemiyor', 'en': 'Device not supported'},
    'reminder_desc': {'tr': 'Sayıma 3 saat kala bildirim alırsınız', 'en': 'Notified 3 hours before'},
    'pick_custom_color': {'tr': 'Özel Renk Seç', 'en': 'Custom Color'},
    ...
    'manager_a1': {'tr': 'A1 Yönetici', 'en': 'Manager A1'},
    'manager_a2': {'tr': 'A2 Yönetici', 'en': 'Manager A2'},
    'manager_a3': {'tr': 'A3 Yönetici', 'en': 'Manager A3'},
    ...
    'report_type': {'tr': 'Rapor Türü', 'en': 'Report Type'},
    'report_type_sayim': {'tr': 'Sayım Raporu', 'en': 'Count Report'},
    'report_type_aylik': {'tr': 'Aylık Çalışma Raporu', 'en': 'Monthly Work Report'},
    'total_unique_personnel': {'tr': 'Aylık Toplam Çalışan Benzersiz Personel Sayısı:', 'en': 'Total Unique Personnel:'},
    'total_personnel_shifts': {'tr': 'Aylık Toplam Personel Çalıştırma Sayısı (Yevmiye):', 'en': 'Total Personnel Shifts:'},
    'total_counts_in_month': {'tr': 'Aylık Toplam Yapılan Sayım Sayısı:', 'en': 'Total Counts in Month:'},
    'unknown_user': {'tr': 'Bilinmeyen Kullanıcı', 'en': 'Unknown User'},
    'order': {'tr': 'Sıra', 'en': 'Order'},
    'personnel_name': {'tr': 'Personel Adı', 'en': 'Personnel Name'},
    'participated_counts': {'tr': 'Katıldığı Sayım Sayısı', 'en': 'Participated Counts'},
    'select_report_type_first': {'tr': 'Önce Rapor Türü Seçiniz', 'en': 'Select Report Type First'},
    ...
    'close_count': {'tr': 'Sayımı Kapat', 'en': 'Close Count'},
    'open_count': {'tr': 'Sayımı Aç', 'en': 'Open Count'},
    ...
    'delete_closed_count_msg': {'tr': 'Bu sayımı silmek istediğinize emin misiniz? Bu işlem geri alınamaz.', 'en': 'Are you sure you want to delete this count? This action cannot be undone.'},
    'delete_open_count_warning': {'tr': 'Uyarı: Kabul edenlere iptal bildirimi gönderilecektir.', 'en': 'Warning: A cancellation notification will be sent to those who accepted.'},
    ...
    'person_successfully_removed': {'tr': 'Kişi başarıyla çıkarıldı.', 'en': 'Person successfully removed.'},
    ...
    'remove_invitation_confirm_msg': {'tr': 'Bu kişinin davet kaydını tamamen silmek istediğinize emin misiniz?', 'en': 'Are you sure you want to completely remove this person\'s invitation record?'},
