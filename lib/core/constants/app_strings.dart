...
class AppStrings {
  ...
  static const Map<String, Map<String, String>> _strings = {
    ...
    'manager_a1_in_city': {'tr': 'Yönetici A1 (Şehir İçi)', 'en': 'Manager A1 (In-City)'},
    'manager_a1_out_city': {'tr': 'Yönetici A1 (Şehir Dışı)', 'en': 'Manager A1 (Out-of-City)'},
    'manager_a2_in_city': {'tr': 'Yönetici A2 (Şehir İçi)', 'en': 'Manager A2 (In-City)'},
    'manager_a2_out_city': {'tr': 'Yönetici A2 (Şehir Dışı)', 'en': 'Manager A2 (Out-of-City)'},
    'manager_a3_in_city': {'tr': 'Yönetici A3 (Şehir İçi)', 'en': 'Manager A3 (In-City)'},
    'manager_a3_out_city': {'tr': 'Yönetici A3 (Şehir Dışı)', 'en': 'Manager A3 (Out-of-City)'},
    ...
    'manager_a1': {'tr': 'Yönetici A1', 'en': 'Manager A1'},
    'manager_a2': {'tr': 'Yönetici A2', 'en': 'Manager A2'},
    'manager_a3': {'tr': 'Yönetici A3', 'en': 'Manager A3'},
