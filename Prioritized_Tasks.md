...
Bu liste, sistemin stabilitesini ve veri tutarlılığını sağlamak için en kritik hatalardan başlayıp, ardından büyük sistem değişiklikleri, yeni özellikler ve en son küçük arayüz/performans iyileştirmelerine doğru mantıksal bir sıraya oturtulmuştur.

## 1. Kritik Hatalar ve Veri Tutarlılığı (Bugs & Data Consistency) - EN YÜKSEK ÖNCELİK

Önce sistemin mevcut işleyişini bozan ve veri kaybına/tutarsızlığına yol açan durumlar çözülmelidir.
...
Sistemin çalışma mantığını (özellikle kayıt ve güvenlik gibi) temelden etkileyecek büyük özellikler.
...
Sisteme eklenecek, işleyişi kolaylaştıracak ikincil derece önemli yeni fonksiyonlar.
...
Kullanıcı deneyimini iyileştirecek tasarımsal dokunuşlar ve kolayca halledilebilecek ufak tefek işlemler.
...
Gözlem gerektiren arka plan araştırmaları.
